...
public class EjecutarProcesos extends JFrame implements KeyListener {
    ...
    private boolean quantumATranscurrido;
    BcpProcesos bcp;
            ...
            public void run() {
                ...
                while (!colaListos.isEmpty() || numProcesosPendientes > 0 || !colaBloqueados.isEmpty()) {
                    ...
                    if (colaBloqueados.size() < 3) {
                        ...
                        if (p.obtenerInterrumpido()||p.quantumATranscurrido()) {
                        ...
                        while (tiempoRestante >= 0) {
                            if (!procesoPausado) {
                                ...
                                txtQuantum.setText(""+contadorQuantum);
                                ...
                                if(contadorQuantum > quantum){
                                    contadorQuantum=0;
                                    quantumATranscurrido = true;
                                    p.establecerTiempoRestante(tiempoRestante+1);
                                    p.establecerQuantum(true);
                                    colaListos.offer(p);
                                    break;
                                }
    ...
    private void initComponents() {
        ...
        lblQuantum.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        lblQuantum.setText("Quantum transcurrido:");

        txtQuantum.setEditable(false);
        txtQuantum.setBackground(new java.awt.Color(255, 255, 255));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(panelColaBloqueados, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
